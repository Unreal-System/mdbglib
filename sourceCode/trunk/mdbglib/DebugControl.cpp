...
namespace MS
{
	namespace Debuggers
	{
		namespace DbgEng
		{
			...
			array<DbgFrame^>^ DebugControl::GetStackTrace(ULONG maxFrames)
			{
...
//    );
			...
			void DebugControl::WaitForEvent(ULONG timeout)
			{
//HRESULT
...
//    IN ULONG  Timeout
//    );
				Tools::CheckHR(this->m_info->Control->WaitForEvent(0, timeout));
			}
